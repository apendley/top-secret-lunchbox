...
class ReactionMatchCorrect(SceneState):
    ...
    def enter(self):
        ...
        # print("NEXT INDEX:", self.scene.current_sequence_index)
    ...
    def update(self, dt):
        ...
        if switchboard.did_change:
            ...
            if switchboard.has_connections:
                ...
                # Prevent circuilar dependency with local import
                from scene.reaction_match.start import ReactionMatchStart
                next_state = ReactionMatchStart(self.scene)
